...
public class DateUtils {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(currentDate(DateUtils.YMDHMS));
        System.out.println(getAppointDateInfo("D", getCurrentDate()));
        System.out.println(convertDate(getCurrentDate(), DateUtils.DATEFORMAT));
        System.out.println(getAppointDate("D", getCurrentDate(), -2, DateUtils.YYYYMMDDHHMMSSSSS));
        System.out.println(getDateDiff("1", getCurrentDate(), getCurrentDate()));
        String str = getAppointDate("D", getCurrentDate(), 0, DateUtils.DATETIMEFORMAT);
        String str1 = getAppointDate("D", getCurrentDate(), 0, DateUtils.DATETIMEFORMAT);
        System.out.println(getDateDiff("D", getDate(str, DateUtils.DATETIMEFORMAT), getDate(str1, DateUtils.DATETIMEFORMAT)));
    }
}
